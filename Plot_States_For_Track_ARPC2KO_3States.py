...
track_name = '20240927_ARPC2KO_movie77_track8' #'20240906_ARPC2KO_movie45_track12'
base_path = './data/tracks/20240927_ARPC2KO_movie77_track8'
save_path = './HMM3StateMovies/HMM_3States_avgtracmag_{}'.format(track_name)
#check to see if the path exists, if not make the directory
if not os.path.exists(save_path):
  os.mkdir(save_path)

save_path_movie = save_path + '/states_cell'
#check to see if the path exists, if not make the directory
...
arpc2ko_cells_states, pooled_arpc2ko_state_df = calculate_segment_metrics(arpc2ko_cells, cell_states_arpc2ko, state_probs_arpc2ko)
